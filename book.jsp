...
<%@page import="bean.Theatre"%>
<%@page import="java.util.ArrayList"%>
<%@page import="daos.Theatredaos"%>
...
<div class="col-lg-3">
        ...
        <div class="list-group" >
            <a href="#" class="list-group-item <%if(request.getParameter("T_id")==null) out.println(" active ");%>">Theatres </a>   <br/>
                   
            <% 
               Theatredaos ncd  =new Theatredaos();
                Moviedaos nd = new Moviedaos();
                ArrayList<Theatre>theatrelist  = ncd.getAllTheatres(); 
    for (Theatre theatre : theatrelist) {%>
    <a href="seat.jsp?T_id=<%=theatre.getT_id()%>" class="list-group-item <%if(String.valueOf(theatre.getT_id()).equals(String.valueOf(request.getParameter("T_id")))) out.println(" active ");%>"> <%=theatre.getT_name()%> </a>   <br/>
                        <%}%>
